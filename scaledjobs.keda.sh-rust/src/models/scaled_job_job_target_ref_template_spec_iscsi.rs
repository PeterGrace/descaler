...
/// ScaledJobJobTargetRefTemplateSpecIscsi : ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://examples.k8s.io/volumes/iscsi/README.md



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default, JsonSchema)]
pub struct ScaledJobJobTargetRefTemplateSpecIscsi {
    ...
    pub secret_ref: Option<crate::models::ScaledJobJobTargetRefTemplateSpecIscsiSecretRef>,
    /// iSCSI Target Portal. The Portal is either an IP or ip_addr:port if the port is other than default (typically TCP ports 860 and 3260).
    #[serde(rename = "targetPortal")]
    pub target_portal: String,
}

impl ScaledJobJobTargetRefTemplateSpecIscsi {
    /// ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: https://examples.k8s.io/volumes/iscsi/README.md
    pub fn new(iqn: String, lun: i32, target_portal: String) -> ScaledJobJobTargetRefTemplateSpecIscsi {
